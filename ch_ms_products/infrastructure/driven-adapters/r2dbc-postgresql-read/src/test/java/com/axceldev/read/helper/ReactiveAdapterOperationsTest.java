...
class ReactiveAdapterOperationsTest {
    ...
    private ReactiveAdapterReadOperations<DummyEntity, DummyData, String, DummyRepository> operations;

    @BeforeEach
    void setUp() {
        repository = Mockito.mock(DummyRepository.class);
        mapper = Mockito.mock(ObjectMapper.class);
        operations = new ReactiveAdapterReadOperations<DummyEntity, DummyData, String, DummyRepository>(
