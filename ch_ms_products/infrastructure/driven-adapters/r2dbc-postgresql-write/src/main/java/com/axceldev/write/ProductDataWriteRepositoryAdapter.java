...
@Repository
public class ProductDataWriteRepositoryAdapter extends ReactiveAdapterWriteOperations<
        Product,
        ProductData,
        Long,
        ProductDataWriteRepository
> implements ProductWriteRepository {

    public ProductDataWriteRepositoryAdapter(ProductDataWriteRepository repository, ObjectMapper mapper) {
