package com.axceldev.read.helper;

import com.axceldev.write.helper.ReactiveAdapterWriteOperations;
...
class ReactiveAdapterOperationsTest {
    ...
    private ReactiveAdapterWriteOperations<DummyEntity, DummyData, String, DummyRepository> operations;

    @BeforeEach
    void setUp() {
        repository = Mockito.mock(DummyRepository.class);
        mapper = Mockito.mock(ObjectMapper.class);
        operations = new ReactiveAdapterWriteOperations<DummyEntity, DummyData, String, DummyRepository>(
