...
import com.axceldev.write.ProductDataWriteRepository;
import com.axceldev.write.ProductDataWriteRepositoryAdapter;
...
class ProductDataRepositoryAdapterTest {
    ...
    @InjectMocks
    ProductDataWriteRepositoryAdapter repositoryAdapter;

    @Mock
    ProductDataWriteRepository repository;
